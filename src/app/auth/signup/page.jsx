      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-2xl bg-[#E6F5FC] backdrop-blur-sm rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="space-y-3 mb-6">
            ...
            {/* Google Button */}
            <button className="w-full px-4 py-2 bg-white hover:bg-slate-50 border border-slate-300 rounded-md transition-colors flex items-center justify-center gap-2">
          ...
          <form className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <label htmlFor="firstName" className="block text-sm text-slate-900">
                  First name
                </label>
                <input
                  id="firstName"
              ...
              <div className="space-y-2">
                <label htmlFor="lastName" className="block text-sm text-slate-900">
                  Last name
                </label>
                <input
                  id="lastName"
